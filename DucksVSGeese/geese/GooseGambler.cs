...
namespace DucksVSGeese.Geese
{
    ...
    /// </summary>
    public class GooseGambler : Goose
    {
        ...
        public GooseGambler(string name) : base(CombatantClass, name, MaximumHP, AttacksAllies, Regeneration)
        {
            // idk maybe do some goose stuff here
        }
        public GooseGambler() : this(Goose.GetRandomName()) { }
        ...
        public override Attack Attack()
        {
            ...
            return new Attack("Gamble on Bread", ScaleHits(hits), DAttribute.Poison);
        }
