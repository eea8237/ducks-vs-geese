...
namespace DucksVSGeese.Ducks
{
    ...
    /// </summary>
    public class ProteanDuck : Duck
    {
        private const int MaximumHP = 145;
        private const string CombatantClass = "Protean Duck";
        private const bool AttacksAllies = false;
        public ProteanDuck(string name) : base(CombatantClass, name, MaximumHP, AttacksAllies)
        {
            // idk maybe do some duck stuff here
        }
        public ProteanDuck() : this(Duck.GetRandomName()) { }
